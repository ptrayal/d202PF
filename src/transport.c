...
ACMD(do_speeder)
{
    ...
    if (!*argument)
    {
        ...
        {
            if (atoi(((CONFIG_CAMPAIGN == CAMPAIGN_STAR_WARS) ? speeder_locales_sw : speeder_locales_dl)[i][1]) == 30036)
            {
                i++;
                continue;
            }
            if (atoi(((CONFIG_CAMPAIGN == CAMPAIGN_STAR_WARS) ? speeder_locales_sw : speeder_locales_dl)[i][1]) == 30037)
            {
                i++;
                continue;
            }
...
ACMD(do_shuttle)
{
    ...
    if (!*argument)
    {
        ...
        while (atoi(((CONFIG_CAMPAIGN == CAMPAIGN_STAR_WARS) ? shuttle_locales_sw : shuttle_locales_dl)[i][1]) != 0)
        {
            if (atoi(((CONFIG_CAMPAIGN == CAMPAIGN_STAR_WARS) ? shuttle_locales_sw : shuttle_locales_dl)[i][1]) == 30036)
            {
                i++;
                continue;
            }
            if (atoi(((CONFIG_CAMPAIGN == CAMPAIGN_STAR_WARS) ? shuttle_locales_sw : shuttle_locales_dl)[i][1]) == 30037)
            {
                i++;
                continue;
            }
            if (atoi(((CONFIG_CAMPAIGN == CAMPAIGN_STAR_WARS) ? shuttle_locales_sw : shuttle_locales_dl)[i][1]) == 30038)
            {
                i++;
                continue;
            }

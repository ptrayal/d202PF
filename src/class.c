...
/* FEATS FOR RACES */
  ...
  {CLASS_UNDEFINED, RACE_GNOME,     FALSE,  1, FEAT_LOW_LIGHT_VISION, TRUE},
  {CLASS_UNDEFINED, RACE_HALF_ELF,  FALSE,  1, FEAT_LOW_LIGHT_VISION, TRUE},
  {CLASS_UNDEFINED, RACE_DWARF,     FALSE,  1, FEAT_DARKVISION, TRUE},
  {CLASS_UNDEFINED, RACE_HALF_ORC,  FALSE,  1, FEAT_DARKVISION, TRUE},

/* FEATS FOR FORGOTTEN REALMS */
...
/* FEATS FOR DRAGONLANCE CAMPAIGN */

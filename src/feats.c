...
feato(FEAT_AUGMENT_SUMMONING, "Augment Summoning", TRUE, TRUE, FALSE, "-", "Summoned creatures gain +4 Str and Con.");
...
feato(FEAT_ENHANCED_MOBILITY, "Enhanced Mobility", TRUE, FALSE, FALSE, "Duelist Level 3", "ask staff");
...
feato(FEAT_EVASION, "Evasion", TRUE, FALSE, FALSE, "Monk Level 2, Rogue Level 2", "on successful reflex save no damage from spells and effects");
...
feato(FEAT_FASCINATE, "Fascinate", TRUE, FALSE, FALSE, "Bard Level 1", "ask staff");
feato(FEAT_FAST_CRAFTER, "Fast Crafter", TRUE, FALSE, FALSE, "Artisan level 1", "Reduces crafting time");
feato(FEAT_FAST_HEALER, "Fast Healer", TRUE, TRUE, FALSE, "Con 13, Diehard, Endurance.", "+2 hp healed per round");
...
feato(FEAT_FAST_MOVEMENT, "Fast Movement", TRUE, FALSE, TRUE, "Barbarian Level 1", "10ft bonus to speed in light or medium armor");
...
feato(FEAT_FAVORED_ENEMY, "Favored Enemy", TRUE, TRUE, TRUE, "Ranger", "ask staff");
feato(FEAT_FAVORED_ENEMY_AVAILABLE, "Available Favored Enemy Choice(s)", TRUE, FALSE, FALSE, "Ranger", "ask staff");
feato(FEAT_FLURRY_OF_BLOWS, "Flurry of Blows", TRUE, FALSE, FALSE, "Monk Level 1", "extra attack when fighting unarmed at -2 to all attacks");
feato(FEAT_FORGE_RING, "Forge Ring", FALSE, FALSE, FALSE, "Caster level 7th", "Create magic rings"); 
feato(FEAT_GRACE, "Grace", TRUE, FALSE, FALSE, "Duelist Level 4", "ask staff");
feato(FEAT_GREAT_CLEAVE, "Great Cleave", FALSE, FALSE, FALSE, "STR 13, Cleave, Base attack bonus +4", "ask staff");
...
feato(FEAT_GREATER_FLURRY, "Greater Flurry", TRUE, FALSE, FALSE, "Monk Level 11", "extra unarmed attack when using flurry of blows at -5 penalty");
feato(FEAT_GREATER_RAGE, "Greater Rage", TRUE, FALSE, FALSE, "Barbarian Level 11", "+6 to str and con when raging");
...
feato(FEAT_GREATER_WEAPON_FOCUS, "Greater Weapon Focus", TRUE, TRUE, TRUE, "Weapon Focus, 4th-level fighter", "additional +1 to hit rolls with weapon (stacks)");
feato(FEAT_GREATER_WEAPON_SPECIALIZATION, "Greater Weapon Specialization", TRUE, TRUE, TRUE, "Weapon Specialization, 12th-level fighter", "additional +2 dam with weapon (stacks)");
...
feato(FEAT_HIDE_IN_PLAIN_SIGHT, "Hide in Plain Sight", TRUE, FALSE, FALSE, "Ranger Level 17, Assassin Level 8", "ask staff");
feato(FEAT_IMPROVED_BULL_RUSH, "Improved Bull Rush", FALSE, FALSE, FALSE, "Str 13, Power Attack, Base attack bonus +1", "ask staff");
...
feato(FEAT_IMPROVED_OVERRUN, "Improved Overrun", FALSE, FALSE, FALSE, "Power Attack, Base attack bonus +1", "ask staff");
feato(FEAT_IMPROVED_PRECISE_SHOT, "Improved Precise Shot", TRUE, FALSE, FALSE, "Ranger Level 11", "+1 to hit on all ranged attacks");
feato(FEAT_IMPROVED_REACTION, "Improved Reaction", TRUE, FALSE, FALSE, "Duelist Level 2", "+2 bonus to initiative checks (+4 at 8th class level)");
...
feato(FEAT_KI_CRITICAL, "Ki Critical", TRUE, FALSE, FALSE, "Weapon Master 7th", "Weapons of choice have +1 to threat range per rank");
feato(FEAT_KI_DAMAGE, "Ki Damage", TRUE, FALSE, FALSE, "Weapon Master 1st", "Weapons of Choice have 5 percent chance to deal max damage");
feato(FEAT_KI_STRIKE, "Ki Strike", TRUE, FALSE, FALSE, "-", "unarmed attack considered a magical weapon");
...
feato(FEAT_PERFECT_SELF, "Perfect Self", TRUE, FALSE, FALSE, "-", "10/magic damage reduction");
...
feato(FEAT_PURITY_OF_BODY, "Purity of Body", TRUE, FALSE, FALSE, "-", "immune to poison");
...
feato(FEAT_QUIVERING_PALM, "Quivering Palm", TRUE, FALSE, FALSE, "-", "chance to kill on strike with unarmed attack");
...
feato(FEAT_SLEEP_PARALYSIS_IMMUNITY, "Sleep & Paralysis Immunity", TRUE, FALSE, FALSE, "Dragon Disciple level 10", "ask staff");
...
feato(FEAT_SMITE_EVIL, "Smite Evil", TRUE, FALSE, FALSE, "-", "add level to hit roll and charisma bonus to damage");
...
feato(FEAT_THOUSAND_FACES, "A Thousand Faces", TRUE, FALSE, FALSE, "Druid Level 13", "ask staff");
feato(FEAT_TIMELESS_BODY, "Timeless Body", TRUE, FALSE, FALSE, "-", "immune to negative agining effects");
...
feato(FEAT_WEAPON_PROFICIENCY_DEITY, "Weapon Proficiency (Deity)", TRUE, FALSE, FALSE, "Cleric level 1st", "Clerics are proficient with the favored weapon of their deity");
...
feato(FEAT_WEAPON_PROFICIENCY_WIZARD, "Weapon Proficiency (Wizard)", FALSE, FALSE, FALSE, "ask staff", "ask staff");
...
feato(FEAT_WHOLENESS_OF_BODY, "Wholeness of Body", TRUE, FALSE, FALSE, "-", "can heal class level *2 hp to self");

...
static variable_name_t VariableNameTable[eMSDP_MAX+1] = 
{
   ...
   { eMSDP_BANK,             "BANK",            NUMBER_READ_ONLY }, 
   { eMSDP_MOVEMENT,         "MOVEMENT",         NUMBER_READ_ONLY }, 
   { eMSDP_MOVEMENT_MAX,     "MOVEMENT_MAX",     NUMBER_READ_ONLY }, 
   { eMSDP_HITROLL,          "HITROLL",          STRING_READ_ONLY }, 
   { eMSDP_DAMROLL,          "DAMROLL",          STRING_READ_ONLY }, 
   { eMSDP_AC,               "AC",               NUMBER_READ_ONLY }, 
   { eMSDP_FORT,             "FORT",             NUMBER_READ_ONLY }, 
   ...
   { eMSDP_ROOM_MAP,         "ROOM_MAP",         STRING_READ_ONLY },
   ...
   // Affects
   { eMSDP_NOHEAL,           "NOHEAL",           NUMBER_READ_ONLY },
   { eMSDP_NOCAMP,           "NOCAMP",           NUMBER_READ_ONLY },

   // Group Variables
   { eMSDP_GROUP1_NAME,      "GROUP1_NAME",      STRING_READ_ONLY },
   { eMSDP_GROUP1_CUR_HP,    "GROUP1_CUR_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP1_MAX_HP,    "GROUP1_MAX_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP1_CUR_MV,    "GROUP1_CUR_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP1_MAX_MV,    "GROUP1_MAX_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP1_TNL,       "GROUP1_TNL",       NUMBER_READ_ONLY },
   { eMSDP_GROUP2_NAME,      "GROUP2_NAME",      STRING_READ_ONLY },
   { eMSDP_GROUP2_CUR_HP,    "GROUP2_CUR_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP2_MAX_HP,    "GROUP2_MAX_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP2_CUR_MV,    "GROUP2_CUR_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP2_MAX_MV,    "GROUP2_MAX_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP2_TNL,       "GROUP2_TNL",       NUMBER_READ_ONLY },
   { eMSDP_GROUP3_NAME,      "GROUP3_NAME",      STRING_READ_ONLY },
   { eMSDP_GROUP3_CUR_HP,    "GROUP3_CUR_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP3_MAX_HP,    "GROUP3_MAX_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP3_CUR_MV,    "GROUP3_CUR_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP3_MAX_MV,    "GROUP3_MAX_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP3_TNL,       "GROUP3_TNL",       NUMBER_READ_ONLY },
   { eMSDP_GROUP4_NAME,      "GROUP4_NAME",      STRING_READ_ONLY },
   { eMSDP_GROUP4_CUR_HP,    "GROUP4_CUR_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP4_MAX_HP,    "GROUP4_MAX_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP4_CUR_MV,    "GROUP4_CUR_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP4_MAX_MV,    "GROUP4_MAX_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP4_TNL,       "GROUP4_TNL",       NUMBER_READ_ONLY },
   { eMSDP_GROUP5_NAME,      "GROUP5_NAME",      STRING_READ_ONLY },
   { eMSDP_GROUP5_CUR_HP,    "GROUP5_CUR_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP5_MAX_HP,    "GROUP5_MAX_HP",    NUMBER_READ_ONLY },
   { eMSDP_GROUP5_CUR_MV,    "GROUP5_CUR_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP5_MAX_MV,    "GROUP5_MAX_MV",    NUMBER_READ_ONLY },
   { eMSDP_GROUP5_TNL,       "GROUP5_TNL",       NUMBER_READ_ONLY },

   { eMSDP_CAMPAIGN,         "CAMPAIGN",       NUMBER_READ_ONLY },
